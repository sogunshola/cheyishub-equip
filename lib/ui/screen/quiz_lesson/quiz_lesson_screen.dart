          ...
          child: Row(
            ...
            children: <Widget>[
              SizedBox(
                  width: 35,
                  height: 35,
                  child:  (state.quizResponse.prev_lesson != "")? FlatButton(
                    shape: new RoundedRectangleBorder(
                        borderRadius: new BorderRadius.circular(20.0),
                        ...
                        switch (state.quizResponse.prev_lesson_type) {
                          case "video":
                            Navigator.of(context).pushReplacementNamed(
                              ...
                              arguments: LessonVideoScreenArgs(widget.courseId,
                                  int.tryParse(state.quizResponse.prev_lesson),
                                  widget.authorAva, widget.authorName, false,
                                  true),
                            );
                            break;
                          case "quiz":
                          ...
                          default:
                            Navigator.of(context).pushReplacementNamed(
                              ...
                              arguments: TextLessonScreenArgs(widget.courseId,
                                  int.tryParse(state.quizResponse.prev_lesson),
                                  widget.authorAva, widget.authorName, false,
                                  true
                              ),
                    ...
                    if(state.quizResponse.next_lesson!="") {
                      switch (state.quizResponse.next_lesson_type) {
                        case "video":
                          Navigator.of(context).pushReplacementNamed(
                            ...
                            arguments: LessonVideoScreenArgs(widget.courseId,
                                ...
                                widget.authorAva, widget.authorName, false, true
                            ),
                          );
                          break;
                        case "quiz":
                          Navigator.of(context).pushReplacementNamed(
                            QuizLessonScreen.routeName,
                            arguments: QuizLessonScreenArgs(widget.courseId, int
                                .tryParse(state.quizResponse.next_lesson),
                                widget.authorAva, widget.authorName
                            ),
                          );
                          break;
                        case "assignment":
                          Navigator.of(context).pushReplacementNamed(
                            AssignmentScreen.routeName,
                            arguments: AssignmentScreenArgs(widget.courseId, int
                                .tryParse(state.quizResponse.next_lesson),
                                widget.authorAva, widget.authorName),
                          );
                          break;
                        ...
                        default:
                          Navigator.of(context).pushReplacementNamed(
                            TextLessonScreen.routeName,
                            arguments: TextLessonScreenArgs(widget.courseId, int
                                .tryParse(state.quizResponse.next_lesson),
                                widget.authorAva, widget.authorName, false, true
                            ),
                          );
